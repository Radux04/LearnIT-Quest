...
Il database della LearnIT Corp è stato attaccato. Hai [b]10 MINUTI[/b] per rimetterlo in sesto scrivendo query nella console. A cronometro scaduto la partita è persa.
